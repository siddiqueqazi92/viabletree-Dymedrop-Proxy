module.exports = {
  ...
  fn: async function (inputs, exits) {
    sails.log.debug("Running api/v1/admin/settings/get-one.js");
    try {
      ...
      //     type: "GET",
      //     server: "AUTH",////////////////////////////////////////////////////////
      //     endpoint: `settings/${inputs.user_id}`,
      ...
      sails.log.error("error calling api/v1/admin/settings/get-one.js", err.message);
      if (
